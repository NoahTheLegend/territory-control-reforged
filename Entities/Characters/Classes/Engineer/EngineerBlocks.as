...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int teamnum = 7)
{
	...
	AddIconToken("$icon_separator$", "Separator.png", Vec2f(8, 8), 5, teamnum);
	AddIconToken("$icon_jumper$", "Jumper.png", Vec2f(8, 16), 0, teamnum);
	AddIconToken("$icon_extractor$", "AutomationIcons.png", Vec2f(24, 48), 0, teamnum);
	AddIconToken("$icon_invcleaner$", "AutomationIcons.png", Vec2f(24, 48), 1, teamnum);
	AddIconToken("$icon_hoppacker$", "Hoppacker.png", Vec2f(24, 24), 4, teamnum);
	AddIconToken("$icon_compactor$", "Compactor.png", Vec2f(24, 32), 0, teamnum);
	...
	AddIconToken("$icon_siren$", "Siren.png", Vec2f(24, 24), 0, teamnum);
	...
	AddIconToken("$icon_1x5blastdoor$", "1x5BlastDoor.png", Vec2f(8, 24), 0, teamnum);
	AddIconToken("$icon_gate$", "Gate.png", Vec2f(8, 24), 1, teamnum);
