...
void onInit(CBlob@ this)
{
	...
	u8 shop_width = 4;
	u8 space = this.get_u32("shop_space");
	u8 height = Maths::Floor(space/shop_width);

	this.set_Vec2f("shop menu size", Vec2f(shop_width, space % shop_width == 0 ? height : height + 1));
