...
void onInit(CBlob@ this)
{
	...
	{
		AssemblerItem i("beagle", 1, "UPF Beagle (1)");
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 6);
		items.push_back(i);
	}
	{
		AssemblerItem i("uzi", 1, "UPF Submachine Gun (1)");
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 6);
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 12);
		items.push_back(i);
	}
	{
		AssemblerItem i("assaultrifle", 1, "UPF Assault Rifle (1)");
	...
	{
		AssemblerItem i("silencedrifle", 1, "UPF Suppressed Rifle (1)");
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 24);
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 24);
		items.push_back(i);
	}
	{
		AssemblerItem i("sar", 1, "UPF Semiautomatic Rifle (1)");
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 24);
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 12);
		items.push_back(i);
	}
	{
		AssemblerItem i("msgl", 1, "UPF Multi-Shot Grenade Launcher AV-140 (1)");
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 64);
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 24);
		items.push_back(i);
	}
	{
	...
	}
	{
		...
		AddRequirement(i.reqs, "blob", "mat_steelingot", "Steel Ingot", 72);
		items.push_back(i);
	}
	{
