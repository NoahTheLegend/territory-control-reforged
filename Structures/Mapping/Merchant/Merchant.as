...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Buy Stone (2000)", "$mat_stone_10x$", "mat_stone-2000", "Buy 2000 stone for 1250 coins.");
		AddRequirement(s.requirements, "coin", "", "Coins", 1000);
		s.spawnNothing = true;
	}
	{
	...
	{
		ShopItem@ s = addShopItem(this, "Buy Wood (2000)", "$mat_wood_10x$", "mat_wood-2000", "Buy 2000 wood for 800 coins.");
		AddRequirement(s.requirements, "coin", "", "Coins", 640);
		s.spawnNothing = true;
	}
	{
