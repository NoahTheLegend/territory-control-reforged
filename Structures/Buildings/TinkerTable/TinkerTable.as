...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Advanced Automation Blueprint", "$bp_aa_icon$", "bp_automation_advanced", "The blueprint for the automated chicken assembler.", true);
		AddRequirement(s.requirements, "blob", "mat_acid", "Acid", 200);
