...
void RenderRain(CBlob@ this, int id)
{
	...
	if (Rain_vs.size() > 0)
	{
		...
		f32 alpha = Maths::Clamp(Maths::Min((tsc-256.0f)*0.1f, Maths::Max(fog, 255) * modifier), 0, 215*Maths::Min(1.0f, level));
		f32 rain_alpha = tsc_mod * Maths::Clamp(255-255*this.get_f32("time_mod"), 10, 160);
